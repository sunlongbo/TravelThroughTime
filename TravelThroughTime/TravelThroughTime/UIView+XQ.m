...
//{
//    // 左边
//    UIImageView *leftImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, width, height)];
//    leftImageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"%ld.jpg",(long)1]];
//    
//    leftFoldView = [[MultiFoldView alloc] initWithFrame:self.view.bounds folds:3 pullFactor:0.9];
//    leftFoldView.delegate = nil;
//    [leftFoldView setContent:leftImageView];
//    [self.view addSubview:leftFoldView];
//    
//    // 当前
//    UIImageView *curImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, width, height)];
//    curImageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"%ld.jpg",(long)2]];
//    
//    curFoldView = [[MultiFoldView alloc] initWithFrame:self.view.bounds folds:3 pullFactor:0.9];
//    curFoldView.delegate = nil;
//    [curFoldView setContent:curImageView];
//    [self.view addSubview:curFoldView];
//    
//    // 右边
//    UIImageView *rightImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, width, height)];
//    rightImageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"%ld.jpg",(long)3]];
//    
//    rightFoldView = [[MultiFoldView alloc] initWithFrame:self.view.bounds folds:3 pullFactor:0.9];
//    rightFoldView.delegate = nil;
//    [rightFoldView setContent:rightImageView];
//    [self.view addSubview:rightFoldView];
//}
...
//        imageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"%ld.jpeg",(long)i+1]];
//        
//        MultiFoldView *foldView = [[MultiFoldView alloc] initWithFrame:self.view.bounds folds:3 pullFactor:0.9];
//        foldView.delegate = nil;
